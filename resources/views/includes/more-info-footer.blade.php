    ...
    <div class="container">
        <div class="c-footer__description-content">
            <div class="c-footer__content">
                ...
                <article class="c-footer__seo" style="width: 40%;">
...
<script>
    var a=0;function show(){$("#js-footer-readmore-content").toggleClass("c-footer__seo-readmore"),0===a?($("#js-footer-readmore").html("بستن"),a=1):($("#js-footer-readmore").html("مشاهده بیشتر"),a=0)}
</script>