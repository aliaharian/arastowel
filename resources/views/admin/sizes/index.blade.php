        ...
        <div class="col-md-4">
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن سایز</h3>
              ...
              <form role="form" action="{{route('sizes.store')}}" method="POST">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required id="size_name" name="size_name" placeholder="نام سایز">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">نام انگلیسی سایز</label>
                    <input type="text" class="form-control" required id="size_english_name" name="size_english_name" placeholder="size name">
                  </div>
