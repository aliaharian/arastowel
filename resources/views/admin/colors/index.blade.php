        ...
        <div class="col-md-4">
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن رنگ</h3>
              ...
              <form role="form" action="{{route('colors.store')}}" method="POST">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" required id="color_name" name="color_name" placeholder="نام رنگ">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">نام انگلیسی رنگ</label>
                    <input type="text" class="form-control" required id="color_english_name" name="color_english_name" placeholder="color name">
                  </div>
