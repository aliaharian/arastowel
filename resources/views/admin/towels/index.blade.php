      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">افزودن حوله</h3>
            ...
            <div class="box-body no-padding">
              <form role="form" action="{{route('towels.store')}}" method="POST">
                @csrf
                <div class="box-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">نام حوله</label>
                    <input type="text" class="form-control" required id="towel_name" name="towel_name" placeholder="نام حوله">
                  </div>
        ...
        <div class="col-md-8">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">حوله های خاص</h3>
