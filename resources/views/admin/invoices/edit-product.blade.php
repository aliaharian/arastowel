...
<style>
  ...
  <link rel="stylesheet" href="https://statics.arastowel.com/panel-admin/css/persian-datepicker-0.4.5.min.css" />
            ...
            <div class="box-body no-padding">
              <div class="input-group gallery-box" id="gallery-box" style="display: block;">
                ...
                @foreach($product->galleries as $gallery)
                  ...
                  @endforeach
                  <a href="/roza-admin/elfinder/popup/gallery1" class="col-sm-4 add-gallery" id="gallery1"> @if(isset($galleryArray[0])) <img src="{{$galleryArray[0]}}" style="width: 100%;height:100%"><span class="deletegaler" id="deletegallery8" onclick="deleteGallery1Image()">X</span> @else + @endif </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery2" class="col-sm-4 add-gallery" id="gallery2"> @if(isset($galleryArray[1])) <img src="{{$galleryArray[1]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery2Image()">X</span> @else + @endif  </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery3" class="col-sm-4 add-gallery" id="gallery3"> @if(isset($galleryArray[2])) <img src="{{$galleryArray[2]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery3Image()">X</span> @else + @endif  </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery4" class="col-sm-4 add-gallery" id="gallery4"> @if(isset($galleryArray[3])) <img src="{{$galleryArray[3]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery4Image()">X</span> @else + @endif  </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery5" class="col-sm-4 add-gallery" id="gallery5"> @if(isset($galleryArray[4])) <img src="{{$galleryArray[4]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery5Image()">X</span> @else + @endif  </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery6" class="col-sm-4 add-gallery" id="gallery6"> @if(isset($galleryArray[5])) <img src="{{$galleryArray[5]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery6Image()">X</span> @else + @endif  </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery7" class="col-sm-4 add-gallery" id="gallery7"> @if(isset($galleryArray[6])) <img src="{{$galleryArray[6]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery7Image()">X</span> @else + @endif  </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery8" class="col-sm-4 add-gallery" id="gallery8"> @if(isset($galleryArray[7])) <img src="{{$galleryArray[7]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery8Image()">X</span> @else + @endif  </a>
                  ...
                  <a href="/roza-admin/elfinder/popup/gallery9" class="col-sm-4 add-gallery" id="gallery9"> @if(isset($galleryArray[8])) <img src="{{$galleryArray[8]}}" style="width: 100%;height:100%"><span class="deletegaler " id="deletegallery8" onclick="deleteGallery9Image()">X</span> @else + @endif  </a>
                          ...
                          <div class="box-header with-border">
                            ...
                            <div id="collapse{{$color->english_name}}" class="panel-collapse collapse">
                              <div class="box-body color-box-body">
                                <div class="input-group">
                                  <span class="input-group-addon" id="picture{{$color->english_name}}">@if($product->hasColor($color->id)) <a onclick="deleteImage('{{$color->english_name}}')"><i class="fa fa-times btn btn-danger btn-lg"></i></a><img class="variableImage" src="@foreach($selectedColors as $selectedColor) @if($selectedColor->product_id==$product->id && $selectedColor->color_id==$color->id){{$selectedColor->image}} @endif @endforeach" />  @else تصویر @endif</span>
                                  <button type="button" class="browse btn btn-primary" id="imageUpload{{$color->english_name}}" > انتخاب تصویر </button>
                                  <input type="text" style="width: 100%;height: 100%" id="featured_image{{$color->english_name}}" placeholder="آدرس تصویر" value="@foreach($selectedColors as $selectedColor) @if($selectedColor->product_id==$product->id && $selectedColor->color_id==$color->id){{$selectedColor->image}} @endif @endforeach" readonly name="imageColor{{$color->id}}" />
                                </div>
                              </div>
                            </div>
...
<script src="https://statics.arastowel.com/js/add-Product.js"></script>
